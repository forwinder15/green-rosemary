...
export default class Header extends React.Component {
  render() {
    return ( <
      header id = "masthead"
      className = {
        'site-header ' + _.get(this.props, 'pageContext.site.siteMetadata.header.bg')
      } >
      <
      ...
      div className = "site-branding" > {
        ...
        Link to = {
          ...
          safePrefix(_.get(this.props, 'pageContext.site.siteMetadata.header.profile_img'))
        }
        className = "avatar"
      ...
      div className = "site-identity" > {
        ...
        <
        h1 className = "site-title" > < Link to = {
          safePrefix('/')
        } > {
        ...
        :
          <
          p className = "site-title" > < Link to = {
            safePrefix('/')
          } > {
            _.get(this.props, 'pageContext.site.siteMetadata.header.title')
          } < /Link></p >
      ...
      /div> {
        ...
        className = "menu-toggle" > < span className = "screen-reader-text" > Menu < /span><span className="icon-menu"
      ...
      /div> {
        ...
        aria - label = "Main Navigation" >
          ...
          li className = {
            'menu-item ' + ' current-menu-item' + 'pageContext.url' + "url"
          }
        key = "4" > < Link to = "https://www.paypal.com/donate/?token=KP8kKup9LZ6BST-ynAKb3o6U9HAfS35kGOXggFcomiMe_bgg1g3av-h0Y2Fj5q_pR-Qw10&country.x=US&locale.x=US" > Give < /Link></li >

          <
          li className = {
            'menu-item ' + ' current-menu-item' + 'pageContext.url' + "url"
          }
        key = "3" > < Link to = "/sermons" > Recent Sermons < /Link></li >
          <
          /ul> {
